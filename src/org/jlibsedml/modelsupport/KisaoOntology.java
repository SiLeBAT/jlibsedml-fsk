...
public class KisaoOntology {
    ...
    /**
     * Predefined constant corresponding to KISAO:0000433 describing a generic
     * deterministic simulation.
     */
    public static KisaoTerm ALGORITHM_WITH_DETERMINISTIC_RULES = getInstance()
            .getTermById("KISAO:0000433");
    ...
    void createRelations() {
        for (KisaoTerm term : terms) {
            if(term.getId().equals("KISAO_0000363")) {
                System.err.println("is hit");
            }
