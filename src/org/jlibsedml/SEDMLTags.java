...
public class SEDMLTags {
    ...
    public static final String SIM_ATTR_LANGUAGE = "language";
    public static final String SIM_ATTR_TYPE = "type";
    ...
    public static final String SIM_FSK = "fskSimulation";
    ...
    public static final String OUTPUT_SCRIPT = "script";
    ...
    public static final String OUTPUT_SRC = "src";
    ...
    public static final String SIMUL_FSK_KIND = "fskSimulation";
