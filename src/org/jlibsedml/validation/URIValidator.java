...
/**
 * Validates that URIs in the 'source' attribute of a model can be parsed into
 * URI objects. This method generates a SED-ML error if the attempt at creation
 * of a {@link URI} object fails.
 * 
 * @author radams
 *
 */
    ...
    public List<SedMLError> validate() {
        ...
        for (Model model : models) {
            try {
                ...
                errs.add(new SedMLError(0,
                        "ErrMessageRoot[" + model.getSource() + "]",
