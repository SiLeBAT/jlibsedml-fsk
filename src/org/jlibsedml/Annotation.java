...
public final class Annotation {
	...
	/**
     * Retrieves the  annotation element for this object.
     ...
     */
    public boolean removeElement (Element toRemove){
        Namespace ns = toRemove.getNamespace();
        Iterator<Element> it = elements.iterator();
        while (it.hasNext()) {
            Element el = it.next();
            if (ns != null && ns.equals(el.getNamespace())){
                it.remove();
            }
        }
        return false;
