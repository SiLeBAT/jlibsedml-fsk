 ...
 * If an element has no attributes, selecting the element will select it. In
 * this case, it is assumed that it is a unique element, and no further XPath
 * predicate is added.
 * 
 * @author radams
 *
 */
public class ElementIdentifiedBySelectedAttributePolicy
