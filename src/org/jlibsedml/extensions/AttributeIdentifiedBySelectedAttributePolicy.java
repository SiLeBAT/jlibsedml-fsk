 ...
 *
 */
public class AttributeIdentifiedBySelectedAttributePolicy
        implements ISelectionChangedPolicy {

    public AttributeIdentifiedBySelectedAttributePolicy(Document doc,
            Attribute attIdentifier) {
        super();
        this.doc = doc;
    ...
    public String getXPathForAttribute(Attribute att) {
        try {
            return new XMLUtils().getXPathForAttributeIdentifiedByAttribute(
                    att.getParent(), att, doc, attIdentifier);
