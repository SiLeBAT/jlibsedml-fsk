...
public final class SedML extends SEDBase {
    ...
    static class OutputComparator implements Comparator<Output> {
        ...
        static {
            ...
            changeKindOrder.put(SEDMLTags.SCRIPT_KIND, 4);
        }
     ...
     * already present.
     *
     * @param simulation A non-null {@link Simulation} element
     ...
     * present.
     *
     * @param task A non-null {@link Task} element
     ...
     *
     * @param dataGenerators list of DataGenerators
     */
     ...
     * DataGenerators.
     *
     * @param dg A non-null {@link DataGenerator} element
    ...
    /**
     * Removes all {@link DataGenerator} objects. </p>
     * <strong>Be aware</strong> that removing {@link DataGenerator}s could invalidate the SEDML document if the document
     * contains Outputs.
     *
     * @since 2.3
     */
    ...
    /**
     * Removes all {@link Task} objects. </p>
     * <strong>Be aware</strong> that removing {@link Task}s could invalidate the SEDML document if the document
     * contains DataGenerators or Outputs.
     *
     * @since 2.3
     */
    ...
    /**
     * Removes all {@link Task} objects. </p>
     * <strong>Be aware</strong> that removing {@link Model}s could invalidate the SEDML document if the document
     * contains Tasks, DataGenerators or Outputs.
     *
     * @since 2.3
     */
    ...
    /**
     * Removes all {@link Simulation} objects. </p>
     * <strong>Be aware</strong> that removing {@link Simulation}s could invalidate the SEDML document if the document
     * contains Tasks, DataGenerators or Outputs.
     *
     * @since 2.3
     */
     ...
     *
     * @param modelRef A non-null model Identifier
     ...
     * </p>
     *
     * @param xpath The {@link XPathTarget} identifying the element.
     * @param id    A suggested ID for the Variable element. If this ID is not
     ...
     * @param name  An optional name. This will be used for the Variable and
     *              DataGenerator name.
     * @param task  A {@link Task} object.
     * @param force A <code>boolean</code>. If <code>true</code>, will force a new
     ...
     * @throws IllegalArgumentException if any argument except <code>name</code> is null.
     * @since 2.1
     */
     ...
     * </ul>
     *
     * @param task                    The {@link Task} to which the DataGenerators will refer. This
     *                                object MUST belong to this SEDML object
     * @param attributeIdentifierName The name of the attribute used to uniquely identify the
     *                                elements to which DataGenerators will refer. For example, in
     *                                an SBML file, this parameter would be "id" or "meta_id"
     * @param allOrNothing            A <code>boolean</code>. If <code>true</code>, either all the
     ...
     *                                for each match.
     * @param modelResolver           An {@link IModelResolver} capable of obtaining the model
     *                                content from the Task's model reference.
     * @param idNameList              A var-args list of id-name pairs. The ID part should uniquely
