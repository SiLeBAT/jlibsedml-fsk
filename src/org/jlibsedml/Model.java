...
public final class Model extends AbstractIdentifiableElement {
    ...
    /**
     * Sets the model language that this element refers to. This should ideally
     * be a URN, which may already be defined in {@link SUPPORTED_LANGUAGE}. If
     * no language describes this model, the argument may be <code>null</code>.
     * 
     * @param language
     *            A modelling language name.
     * @since 1.2.0
     */
    ...
    /**
     * Adds a Change to this object's list of Changes, if not already present.
     * 
     * @param change
    ...
    public boolean removeChange(Change change) {
        return listOfChanges.remove(change);
    }

    /**
     * Removes all Changes from this model
     * 
     * @since 2.3
     */
     ...
     * remote location.
     * <li><span style=font-weight:bold> source=urn:miriam:biomodels.db:
     * BIOMD0000000003 </span> A URN to a unique identifier for a model, which
     * requires further resolution. Calling isOpaque() on this URI will return
     * <code>true</code>.
     * </ul>
     * <p/>
     ...
     * </tr>
     * <tr>
     * <td>http://www.cellml.org/models/leloup_gonze_goldbeter_1999_version02
     * </td>
     ...
     * </tr>
     * <tr>
     * <td>http://roedy@www.mindprod.com:80/products/abc.html?type=all&colour=
     * brown #DEF</td>
    ...
    public String toString() {
        return new StringBuffer().append("Model [").append("id=")
                .append(getId()).append(", ").append("name=").append(getName())
